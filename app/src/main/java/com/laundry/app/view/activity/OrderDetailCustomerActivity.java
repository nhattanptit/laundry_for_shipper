...
public class OrderDetailCustomerActivity extends BaseActivity<ActivityOrderDetailCustomerBinding> implements BaseActivity.ConfigPermission, OnMapReadyCallback {
    //----------------------------------------------------------------------------------------------
    //------------ instance variable
    //----------------------------------------------------------------------------------------------
